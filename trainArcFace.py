...
class TrainArcFaceParams(ParamsParent):
    ...
    ckp_time_stamp = "2024-09-04_09-00"   # 实验 1
    ...
    # nohup python -u main.py > ./log/2024-09-04_09-00.txt 2>&1 &
    # 实验 1      1267785
...
def verification_procedure(
    ...
    if save_csv:
        ...
        pdOperator_far.to_csv(
            os.path.join(
                root_dir,
                TrainArcFaceParams.model_name+"_far_frr_"+TrainArcFaceParams.dataset_name+ ".csv"
            ),
            index=False, 
            # header=False
        )
...
def trainArcFaceMain():
    ...
    cls_model = define_model(params.dataset_name, params.backbone_type, params.n_class)
